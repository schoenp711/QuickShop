...
public class SwipeToDeleteCallbackShoppingScreen extends ItemTouchHelper.SimpleCallback {

  /**
   * ShoppingRecyclerViewAdapter
   */
  private ShoppingRecyclerViewAdapter mAdapter;

  /**
   * Set swipe to delete as both right and left swipe
   *
   * @param adapter ShoppingRecyclerViewAdapter
   */
  public SwipeToDeleteCallbackShoppingScreen(ShoppingRecyclerViewAdapter adapter) {
